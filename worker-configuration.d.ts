/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dc9a91f47ebc99d6a724a72a19cf277b)
// Runtime types generated with workerd@1.20251008.0 2025-08-23 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		AUTUMN_SECRET_KEY_PROD: string;
		RUNABLE_GATEWAY_URL: string;
		VITE_BETTER_AUTH_URL: string;
		ADMIN_EMAIL: string;
		VITE_ZOOM_SDK_KEY: string;
		ZOOM_SDK_KEY: string;
